...
async def load_photo(message: types.Message, state: FSMContext):
    if id == ID:
        ...
        await FSMAdmin.next()
        await message.reply('теперь введите ваше название ')
...
async def load_name(message: types.Message, state: FSMContext):
    if message.from_user.id == ID:
        ...
        await FSMAdmin.next()
        await message.reply('теперь введите ваше описание')
...
@dp.callback_query_handler(lambda x: x.data and x.data.startswicth('del'))
